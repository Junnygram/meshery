...
export default function PublishDesignModal(props) {
  ...
  return (
    <Modal open={open} title={title} closeModal={handleClose}>
      <RJSFModalWrapper
        ...
        helpText={
          <p>
            Upon submitting your catalog item, an approval flow will be initiated. Learn more in our{' '}
            <a href="https://docs.meshery.io/concepts/catalog" target="_blank" rel="noreferrer">
              documentation
            </a>
            .
          </p>
