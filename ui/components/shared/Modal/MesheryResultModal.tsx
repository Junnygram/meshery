...
/**
 * MesheryResultModal displays detailed results of a performance test.
 */
function MesheryResultModal(props) {
...
MesheryResultModal.propTypes = {
  rowData: PropTypes.object.isRequired,
  close: PropTypes.func.isRequired,
};

export default MesheryResultModal;
